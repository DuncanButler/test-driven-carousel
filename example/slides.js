...
export default [
  {
    ...
    imgUrl:
      ...
      '&ixid=eyJhcHBfaWQiOjIzOjIzODE4fQ&s=568095e79ee2cb55a795ad454ac9cf5e',
  },
  {
    description: 'Chicago',
    attribution: getAttribution({
  ...
  },
  {
    ...
    imgUrl:
      ...
      '&ixid=eyJhcHBfaWQiOjIzODE4fQ&s=e836c604036680eeba5c77ebdb71c73',
  },
  {
    description: 'New York',
    attribution: getAttribution({
      name: 'Anthony DELANOIX',
      username: 'anthonydedelanoix',
    }),
    imgUrl:
      'https://images.unsplash.com/photo-1423655156442-ccc11daa4e99?w=1080' +
      '&ixid=eyJhcHBfaWQiOjIzOOE4fQ&s=54a272d03f5c06c416e8899f113dff06',
  },
  {
    description: 'Rio de Janeriro',
    attribution: getAttribution({
      name: 'Agustin Diaz',
